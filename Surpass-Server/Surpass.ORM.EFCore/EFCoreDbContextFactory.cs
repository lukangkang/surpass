...
{/// <summary>
 ...
 /// </summary>
    public class EFCoreDatabaseContextFactory : IDatabaseContextFactory
    {
        ...
        /// 数据库上下文的缓存池<br/>
        /// </summary>
        protected EFCoreDbContextPool Pool { get; set; }
        ...
        protected void MigrateDatabase()
        {
            ...
            using (var context = new EFCoreDbContextBase(Database, ConnectionString))
            {
            ...
            using (var context = new EFCoreDbContext(Database, ConnectionString, Handlers, Providers))
            {
