...
namespace Surpass.ORM.EFCore
{
    ...
    public class EFCoreEntityMappingBuilder<T>:IEntityMappingBuilder<T> where T:class,IEntity
    {
        /// <summary>
        ...
        /// ORM名称<br/>
        /// </summary>
        public string ORM => EFCoreDbContext.ConstORM;
            ...
            IEnumerable<IEntityMappingProvider> providers)
        {
            ...
            foreach (var entityMappingProvider in providers)
            {
                var provider = (IEntityMappingProvider<T>) entityMappingProvider;
