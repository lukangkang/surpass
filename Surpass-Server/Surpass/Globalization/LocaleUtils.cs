...
namespace Surpass.Globalization {
	/// <summary>
	...
	public static class LocaleUtils {
		...
		/// 储存语言代码使用的键<br/>
		/// </summary>
		public const string LanguageKey = "Surpass.Language";
		/// <summary>
		/// The key for store using timezone<br/>
		/// 储存时区使用的键<br/>
		/// </summary>
		public const string TimeZoneKey = "Surpass.TimeZone";
        /// <summary>
        /// 当前的HttpContext
        /// </summary>
        ...
        /// CultureInfo的缓存<br/>
        /// </summary>
        private static readonly ConcurrentDictionary<string, CultureInfo> ClutureInfoCache =
		...
		/// </summary>
		private static readonly IDictionary<string, string> OlsonToWindowsTimezoneMapping =
		...
		/// </summary>
		private static readonly IDictionary<string, string> WindowsToOlsonTimezoneMapping =
	    ...
	    public static bool SetThreadTimezone(string timezone)
	    {
	        ...
	        if (timezoneInfo != null)
	        {
	            Context.Items[TimeZoneKey] = timezoneInfo;
	            return true;
	        }
	        return false;
	    }
