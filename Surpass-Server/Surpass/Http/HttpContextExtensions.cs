...
{
    /// <summary>
    /// HttpContext extension methods<br/>
    /// Http上下文的扩展函数<br/>
    /// </summary>
    public static class HttpContextExtensions
    {
        ...
        /// </code>
        /// </example>
        public static void PutData<T>(this HttpContext context, string key, T data)
        {
        ...
        public static T GetData<T>(
            this HttpContext context, string key, T defaultValue = default(T))
        {
        ...
        public static T GetOrCreateData<T>(
            this HttpContext context, string key, Func<T> defaultCreater)
        {
        ...
        public static void RemoveData(
            this HttpContext context, string key)
        {
        ...
        /// 我们需要知道之前写入了什么值<br/>
        /// </summary>
        public const string SetCookieDataKeyPrefix = "Surpass.SetCookie.";
        ...
        public static void PutCookie(
            this HttpContext context, string key, string value, CookieOptions options = null)
        {
            ...
            context.Response.Cookies.Append(key, cookie, options ?? new CookieOptions());
        }
        ...
        {
            var options = new CookieOptions { Expires = DateTime.SpecifyKind(new DateTime(1970, 1, 1), DateTimeKind.Utc) };
        ...
        /// </summary>
        private static readonly Regex MobileCheckRegex = new Regex(
        ...
        /// </summary>
        public const string DeviceKey = "Surpass.Device";
        ...
        /// </code>
        /// </example>
        public static DeviceTypes GetClientDevice(this HttpContext context)
        {
            ...
            {
                var userAgent = context.Request.Headers.GetOrDefault("User-Agent");
        ...
        /// </code>
        /// </example>
        public static void SetClientDeviceToCookies(this HttpContext context, DeviceTypes type)
        {
